...
export default function App() {
  ...
  const updateArticle = ({ article_id, newArticle }) => {
    ...
    axiosWithAuth().put(`http://localhost:9000/api/articles/${article_id}`,newArticle)
        ...
        <Routes>
          ...
          <Route path="articles" element={
            <>
              ...
              <Articles currentArticleId={currentArticleId} articles={articles} getArticles={getArticles} deleteArticle={deleteArticle} setCurrentArticleId={setCurrentArticleId} updateArticle={updateArticle} />
            </>
          } />
        </Routes>
